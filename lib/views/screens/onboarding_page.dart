...
const Name aboutDecisions = Name(
  ru: '«Тайна Сары-Кёль»\u{00A0}— это игра-сериал про дружбу, любовь и свободу. В главной роли игры\u{00A0}—\u{00A0}ты!'
      '\n\nИменно от твоих решений зависит, как сложится судьба наших героев, и чем все закончится. Обещаем, скучно не будет!',
  kg: '«Сары-Көл сыры»\u{00A0}— бул достук, сүйүү жана эркиндик тууралуу оюн-сериал. Оюндун башкы каарманы сенсиң!'
